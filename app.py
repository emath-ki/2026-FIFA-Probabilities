...
with tab1:
    ...
    with chart_col2:
        ...
        st.markdown(
            ...
            f"<p style='color:{C_TEAL};font-size:0.8rem;margin-top:0;margin-bottom:8px;'>"
            f"Competitive balance score · colour = avg away-win</p>",
            unsafe_allow_html=True,
        )
        bal_df = (
            df.groupby("group")
    ...
    # ══════════════════════════════════════════════════════════════════════════════
    #  SECTION 3 — UPSET POTENTIAL
    # ══════════════════════════════════════════════════════════════════════════════
    st.markdown(
        f"<h3 style='color:{C_WHITE};font-size:1.05rem;font-weight:600;margin-bottom:2px;'>"
        f"🎲 Upset Potential by Group</h3>"
        f"<p style='color:{C_TEAL};font-size:0.8rem;margin-top:0;margin-bottom:8px;'>"
    ...
    TERMS = [
        ...
        },
        {
            ...
            "detail":   (
                ...
                "to least balanced. The group at the top is the statistical 'Group of Death' — where every "
        ...
        {
            "icon":     "🐶",
            "term":     "Underdog-Friendly Group",
            "snapshot": "A group where the away team wins more often than expected.",
            "detail":   (
